 ...
 * - Purpose: Tests the app-initiated action scenario where user can cancel.
 * - Scenario: Shows both Complete and Cancel buttons when the action is app-initiated.
 * - Key Aspect: Ensures the cancel button appears and functions properly in app-initiated flows.
 */
